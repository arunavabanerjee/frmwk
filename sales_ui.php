...
if(empty($_SESSION['current_sale_customer_id'])){
	...
	if(!isset($_POST['customer_search']) && !isset($_POST['customer'])){
	    $cust_data = '<h4 class="smalltitle themecolor">Find Customer</h4>';
	    ...
	    $cust_data .= '<div class="row">';
            $cust_data .= "<div class=\"col-8\"><select style='margin-bottom:10px' name='customer'>";
	    ...
	    $cust_data .='<div class="col-4"><button type="button" class="btn themegradirn-bg text-white ml-1 text-uppercase" onclick="jQuery(\'#findcustomer\').submit();">SELECT</button></div>';
	    $cust_data .= '</div>';
	} 				
}
if(!empty($_SESSION['current_sale_customer_id'])){
  ...
  $cust_data .="</select></div>";
  //$cust_data .='<div class="col-4"><button type="button" class="btn themegradirn-bg text-white ml-1 text-uppercase" onclick="jQuery(\'#findcustomer\').submit();">CLEAR</button></div>';
  $cust_data .= '</div>';
}
