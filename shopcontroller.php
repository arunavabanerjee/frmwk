...
class ShopController extends Controller
{
    ...
    public function myAccount(PageService $pageService, Request $request, CartService $cartService, UserService $userService): Response
    {
		...
		if( $userService->getUser() !== null ){ 
			$wproducts = $userService->getUser()->getCustomersNotes(); $wishlist_products = array();
			foreach($wproducts as $wpId){ array_push($wishlist_products, $pageService->getProduct($wpId)); }
		} 
